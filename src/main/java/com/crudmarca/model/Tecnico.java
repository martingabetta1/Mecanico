...
public class Tecnico {
    ...
    public String toString() {
        return "Tecnico [tecnico_id=" + tecnico_id + ", tecnico_nombre=" + tecnico_nombre + ", tecnico_apellido="
                + tecnico_apellido + ", tecnico_telefono=" + tecnico_telefono + ", fecha_creacion=" + fecha_creacion
